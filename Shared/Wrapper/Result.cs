...
public class Result
{
    ...
    {
        Succeed(SuccessMessages.MovedPermanently);
    }
    #endregion
    ...
    #region SqlDomainError
    public void SqlDomainError(string message, Dictionary<string, string[]> errors)
    {
        Failed(message, errors);
    }
    #endregion
